...
if ($conn->connect_error) {
    ...
    $sql = "INSERT INTO complement (date, doctors, admission, nursing, medical, communication, painManagement, cafeteria, cleanliness, security, billing, patientBeds, noiseLevels, roomAmbiance, amenities, discharge) 
    ...
    if (mysqli_query($conn, $sql)) {
        header("location: complement.php");
