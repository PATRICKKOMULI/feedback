...
<div class="row-fluid">
      <div class="widget-box">
        <div class="widget-title"><span class="icon"><i class="icon-tasks"></i></span>
          <h5>Complaints</h5>
          <div class="buttons"><a href="Complaints.php" class="btn btn-mini btn-success"><i class="icon-add"></i>Add complaint</a></div>
        </div>

		<hr style="border-top:1px dotted #000;"/>
		<form id="form-wizard" class="form-horizontal" method="post" action="complaintsubmit.php">
